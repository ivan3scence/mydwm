...
static const Rule rules[] = {
    ...
    {TERMCLASS, "setbg", NULL, 1 << 7, 0, 1, 0, -1},
...
static Key keys[] = {
    ...
    // SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 3%-; kill -44 $(pidof "
    //       "dwmblocks)")},
    //{0, XF86XK_AudioPrev, spawn, {.v = (const char *[]){"mpc", "prev",
    // NULL}}}, {0, XF86XK_AudioNext, spawn, {.v = (const char *[]){"mpc",
    //"next", NULL}}}, {0,
    // XF86XK_AudioPause,
    // spawn,
    // {.v = (const char *[]){"mpc", "pause", NULL}}},
    //{0, XF86XK_AudioPlay, spawn, {.v = (const char *[]){"mpc", "play",
    // NULL}}}, {0, XF86XK_AudioStop, spawn, {.v = (const char *[]){"mpc",
    //"stop", NULL}}}, {0,
    // XF86XK_AudioRewind,
    // spawn,
    // {.v = (const char *[]){"mpc", "seek", "-10", NULL}}},
